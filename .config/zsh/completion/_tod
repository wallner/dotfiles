...
(import)
_arguments "${_arguments_options[@]}" : \
'-a[Add all projects to config that are not there already]' \
'--auto[Add all projects to config that are not there already]' \
'-h[Print help]' \
'--help[Print help]' \
&& ret=0
;;
...
'section:(n) Commands that change sections' \
...
_tod__config_commands() {
    local commands; commands=(
'about:(a) Get build information about Tod' \
...
(( $+functions[_tod__config__about_commands] )) ||
_tod__config__about_commands() {
    local commands; commands=()
    _describe -t commands 'tod config about commands' commands "$@"
}
...
(( $+functions[_tod__config__help__about_commands] )) ||
_tod__config__help__about_commands() {
    local commands; commands=()
    _describe -t commands 'tod config help about commands' commands "$@"
}
...
(( $+functions[_tod__help__config__about_commands] )) ||
_tod__help__config__about_commands() {
    local commands; commands=()
    _describe -t commands 'tod help config about commands' commands "$@"
}
