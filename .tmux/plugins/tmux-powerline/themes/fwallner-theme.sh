...
if [ -z $TMUX_POWERLINE_LEFT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info ${SOLARIZED_BASE03} ${SOLARIZED_BASE1} ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}" \
		"hostname ${SOLARIZED_BASE03} ${SOLARIZED_BASE1} ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}" \
		#"ifstat 30 255" \
		#"ifstat_sys 30 255" \
...
if [ -z $TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		# "now_playing 234 37" \
		#"cpu 240 136" \
		"load ${SOLARIZED_BASE03} ${SOLARIZED_BASE1} ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		# "tmux_mem_cpu_load 234 136" \
		"battery ${SOLARIZED_BASE0} ${SOLARIZED_RED} ${TMUX_POWERLINE_SEPARATOR_LEFT_BOLD}" \
		# "weather 37 255" \
